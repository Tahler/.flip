...
namespace dotFlip.Tools
{
    public class Pencil : ITool
    {
        ...
        private Path shape;
        public Shape Shape => new Path
        {
            // Copy the other shape
            Data = shape.Data,
            Fill = shape.Fill,
            Width = shape.Width,
            Height = shape.Height,
            // Apply rotation
            RenderTransform = new RotateTransform(random.NextDouble()*360, Thickness/2, Thickness/2)
        };
