    ...
    public class Pencil : ITool
    {
        ...
        public Shape Shape
        {
            get
            {
                ...
                transform.Children.Add(new ScaleTransform(thickness, thickness, pathWidth / 2, pathHeight / 2));
                transform.Children.Add(new RotateTransform(random.NextDouble() * 359, pathWidth / 2, pathHeight / 2));
